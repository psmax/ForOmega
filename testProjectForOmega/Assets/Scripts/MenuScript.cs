...
public class MenuScript : MonoBehaviour
{
    ...
    public IEnumerator LoadBund()
    {
        ...
        using (WWW www = new WWW("file:/E:/Unity/testProjectForOmega/Data/" + ManifestName))
        {
            yield return www;
        ...
        using (WWW www = WWW.LoadFromCacheOrDownload("file://E:/Unity/testProjectForOmega/Data/" + BundleName, manifest.GetAssetBundleHash(BundleName)))
        {
            yield return www;
